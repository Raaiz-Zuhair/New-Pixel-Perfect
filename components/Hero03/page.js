        ...
        <div className="bg-gray-100 ">
            <div className="container mx-auto px-8">
              <div className="flex lg:pb-20  lg:flex-row flex-col lg:justify-between lg:gap-0 gap-5">
                <div className="flex w-full lg:w-4/12  lg:flex-col flex-row lg:justify-start justify-between  gap-20 md:flex-row-reverse">
                  <div className="flex ">
                ...
                <h1 className="lg:text-[58px] w-full lg:w-8/12 text-[30px] font-medium leading-tight lg:text-start text-center">
